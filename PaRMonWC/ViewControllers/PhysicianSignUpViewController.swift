//
//  PhysicianSignUpViewController.swift
//  PaRMonWC
//
...
class PhysicianSignUpViewController: UIViewController {
    ...
    func setUpElements(){
        ...
        Utilities.styleTextField(hospitalTextField)
        Utilities.styleTextField(workIDTextField)
    ...
    func validateFields() -> String? {
        ...
        if  fNameTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" || lNameTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" ||
            ...
            specialityTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" ||
            hospitalTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" ||
            workIDTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" ||
    ...
    @IBAction func signUpTapped(_ sender: Any) {
        ...
        if error != nil{
            ...
            showError(error!)
                ...
                let hospital = hospitalTextField.text!.trimmingCharacters(in: .whitespacesAndNewlines)
                let workID = workIDTextField.text!.trimmingCharacters(in: .whitespacesAndNewlines)
                ...
                if  err != nil {
                    ...
                    db.collection("physicians").addDocument(data:  ["fname":fname, "lname":lname, "gender":gender, "speciality":speciality, "hospital":hospital, "workID":workID, "uid":result!.user.uid]){ (error) in
